...
func (g *GallInfo) IsThereDetail() bool {
	if g.koName == "" || g.gServer == "" || g.gNo == "" || g.categoryNo == "" || g.ip == "" {
		return false
	}
	return true
}
...
func (s *Session) PrefetchDetail(a *Article) error {
	...
	a.Gall.koName, a.Gall.gServer, a.Gall.gNo, a.Gall.categoryNo, a.Gall.ip =
